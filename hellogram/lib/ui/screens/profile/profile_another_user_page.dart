...
import 'package:hellogram/ui/helpers/modal_options_another_user.dart';
              ...
              Column(
                children: [
                  TextCustom(
                      ...
                      fontWeight: FontWeight.w500),
                  const TextCustom(
                      text: 'Siguiendo', fontSize: 17, color: Colors.grey),
                ],
              ),
              Column(
                children: [
                  TextCustom(
                      ...
                      fontWeight: FontWeight.w500),
                  const TextCustom(
                      text: 'Seguidores', fontSize: 17, color: Colors.grey),
                ],
              ),
            ],
          ),
